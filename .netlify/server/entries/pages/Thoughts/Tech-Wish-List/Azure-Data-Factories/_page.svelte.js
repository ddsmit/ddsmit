...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h3>Allow Dynamic Selection of a Linked Service from a Dataset</h3>
<p>We have a datafactory that is set up to handle some of our most common use cases. For all of the staging/quality check logic that
...
<p>To reduce complexity, it would be nice to pass in the pipeline that contains specific logic (IE a different source) into a 
...
<p>We have several situations where we have a limited list of options we use to drive behavior. One example is if we want to 
...
<p>For being a tool that developers will likely use, Azure Data Factory&#39;s interface doesn&#39;t seem to accomidate keyboard control 
...
<p>I would personally address many of the issues if the tools was open source. Given that Microsoft as a whole is moving towards fabric,
