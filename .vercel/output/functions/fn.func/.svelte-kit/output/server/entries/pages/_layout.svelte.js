...
const css$3 = {
  code: "header.svelte-1pdte7h.svelte-1pdte7h{position:fixed;display:flex;top:0;left:0;width:100%;top:0;padding:0.5rem;margin:0;background-image:linear-gradient(var(--background-color) 5rem,var(--primary-hover));border-bottom:solid var(--primary-hover) 1px;--mask:conic-gradient(from -45deg at bottom,#0000,#000 1deg 90deg,#0000 91deg) 50% / 60px 100%;-webkit-mask:var(--mask);mask:var(--mask)}ul.svelte-1pdte7h.svelte-1pdte7h{margin:0;display:flex;flex-wrap:wrap;justify-content:space-evenly}.logo.svelte-1pdte7h.svelte-1pdte7h{display:inline-block;width:60vw}.first.svelte-1pdte7h.svelte-1pdte7h:first-letter{font-size:3rem;padding:0;margin-bottom:-10px}.middle.svelte-1pdte7h.svelte-1pdte7h:first-letter{color:var(--primary-hover);font-size:3rem;padding:0;margin-bottom:-10px}.first.svelte-1pdte7h.svelte-1pdte7h{writing-mode:vertical-rl;text-orientation:upright;display:inline;vertical-align:top;padding:0;margin-top:0px}.middle.svelte-1pdte7h.svelte-1pdte7h{writing-mode:vertical-rl;margin-left:-3.6rem;text-orientation:upright;display:inline;vertical-align:top;padding:0;margin-top:0px;margin-bottom:2rem}.last.svelte-1pdte7h.svelte-1pdte7h{font-size:3rem;padding:0;color:green;display:inline-block;margin-left:-2.2rem;margin-top:-7px;vertical-align:top}.hide.svelte-1pdte7h.svelte-1pdte7h{display:none}nav.svelte-1pdte7h.svelte-1pdte7h{display:flex;flex-wrap:wrap;justify-content:space-around;align-content:space-around;padding:0;width:100%}nav.svelte-1pdte7h ul.svelte-1pdte7h{list-style-type:none}nav.svelte-1pdte7h li.svelte-1pdte7h{border-radius:5px;border:white dotted 3px;background-color:black;padding:20px;margin:5px}nav.svelte-1pdte7h li.svelte-1pdte7h:hover{border:solid 3px var(--primary-hover)}",
  map: null
};
const PageHeader = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let hideClass = "hide";
  $$result.css.add(css$3);
  return `<header id="hidebutton" class="svelte-1pdte7h"><div class="logo svelte-1pdte7h"><span class="first svelte-1pdte7h">d<span class="${"menu " + escape(hideClass, true) + " animate blur svelte-1pdte7h"}">avid</span></span>
        <span class="middle svelte-1pdte7h">d<span class="${"menu " + escape(hideClass, true) + " animate blur svelte-1pdte7h"}">ouglas</span></span>
        <span class="last svelte-1pdte7h" id="last">smit</span></div>
    <nav class="${"menu " + escape(hideClass, true) + " animate drop svelte-1pdte7h"}"><ul class="menu svelte-1pdte7h"><a href="/"><li class="svelte-1pdte7h">Home</li></a>
            <a href="/Thoughts"><li class="svelte-1pdte7h">Thoughts</li></a>
            <a href="/History"><li class="svelte-1pdte7h">History</li></a>
            <a href="/Future"><li class="svelte-1pdte7h">Future</li></a></ul></nav></header>`;
});
